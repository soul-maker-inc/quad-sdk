...
public:
   ...
   */
  void groundtruthCallback(const quad_msgs::msg::RobotState::SharedPtr msg);
   ...
   * pos,vel,current
   */
  void jointEncoderCallback(const sensor_msgs::msg::JointState::SharedPtr msg);
   ...
   */
  void contactCallback(const quad_msgs::msg::ContactMode::SharedPtr msg);
  ...
  quad_msgs::msg::RobotState::ConstPtr last_robot_state_msg_;

  // quad_msgs::msg::RobotState last_estimated_state_;
  ...
  /// Last state estimate
  quad_msgs::msg::RobotState last_state_est_;
